...
function generateProfiles(data) {
  ...
  function generateManager(manager) {
    ...
    <div class=" cardT col align-self-center">
      <div class="card " style="width: 16rem;">
        ...
        <ul class="list-group list-group-flush">
          ...
          <li class="list-group-item"><span class="listItem">e-mail: </span><a
    ...
    <!--end of Profile Card - Manager-->`;
  };

  // Generate Engineer Function
  function generateEngineer(engineer) {
    return `
    <!--Profile Card - Engineer-->
    <div class=" cardT col align-self-center">
      <div class="card " style="width: 16rem;">
        <div class="card-header" style="height: 5rem;">
          ${engineer.getName()}
        ...
        <ul class="list-group list-group-flush">
          ...
          <li class="list-group-item"><span class="listItem">GitHub: </span><a
              href="https://github.com/${engineer.getGithub()}" target="_blank">${engineer.getGithub()}</a></li>
        </ul>
      </div>
    </div>
    <!--end of Profile Card - Engineer-->`
  };
